...
TEST(MulMatrixAssignmentOperator, Exception1) {
  // Arrange
  double val = 9.9;
  int row = 3;
  int col = 4;
...
TEST(MulMatrixAssignmentOperator, Exception2) {
  // Arrange
  double val = 9.9;
  int row = 3;
  int col = 4;
...
TEST(MulMatrixAssignmentOperator, NotException1) {
  // Arrange
  double val = 9.9;
  int row = 8;
  int col = 4;
...
TEST(MulMatrixAssignmentOperator, NotException2) {
  // Arrange
  double val = 9.9;
  int row = 3;
  int col = 3;
...
TEST(MulMatrixAssignmentOperator, Equals1) {
  // Arrange
  int row = 4, col = 4;
  double val = 3;
  S21Matrix First{row, col};
...
TEST(MulMatrixAssignmentOperator, Equals2) {
  // Arrange
  S21Matrix Temp{3, 2};
  S21Matrix Temp2{2, 3};
...
TEST(MulMatrixAssignmentOperator, Equals3) {
  // Arrange
  S21Matrix Temp{2, 3};
  S21Matrix Temp2{3, 2};
...
TEST(MulMatrixAssignmentOperator, Equals4) {
  S21Matrix Temp{4, 4};
  S21Matrix Temp2{4, 4};
...
TEST(MulMatrixAssignmentOperator, Equals5) {
  // Arrange
  S21Matrix Temp{4, 2};
  S21Matrix Temp2{2, 4};
  S21Matrix ResultDefault{4, 4};
